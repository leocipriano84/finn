...
export const BANKS = [
  { code: '260', name: 'Nubank',          emoji: '🟣', color: '#820AD1' },
  { code: '341', name: 'Itaú',            emoji: '🟠', color: '#EC7000' },
  { code: '237', name: 'Bradesco',        emoji: '🔴', color: '#CC0000' },
  { code: '033', name: 'Santander',       emoji: '🔴', color: '#EC0000' },
  { code: '104', name: 'Caixa',           emoji: '🔵', color: '#005CA9' },
  { code: '001', name: 'Banco do Brasil', emoji: '🟡', color: '#F9CC1B' },
  { code: '077', name: 'Inter',           emoji: '🟠', color: '#FF7A1A' },
  { code: '336', name: 'C6 Bank',         emoji: '⚫', color: '#242424' },
  ...
  { code: '021', name: 'Banestes',        emoji: '🔵', color: '#003D78' },
